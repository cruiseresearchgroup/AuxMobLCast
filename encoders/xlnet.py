...
from transformers.models.xlnet.modeling_xlnet import XLNetPreTrainedModel, XLNetLayer, XLNetModelOutput
...
class XLNetModel(XLNetPreTrainedModel):
    def __init__(self, config):
        ...
        # self.classifier = torch.nn.Linear(768, 65)
        # self.classifier = torch.nn.Linear(768, 51)
    ...
    def forward(
        ...
        **kwargs,  # delete after depreciation warning is removed
        ...
        # pooled_output = self.classifier(self.sequence_summary(output))
        ...
        return XLNetModelOutput(
            last_hidden_state=output, mems=new_mems, hidden_states=None, attentions=attentions
        )
